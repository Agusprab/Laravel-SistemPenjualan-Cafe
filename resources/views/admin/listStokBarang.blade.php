                        ...
                        <div class="row pb-5">
                           ...
                           @endif
                                      <div class="add-data ml-4 mb-4">
                                        <a href="{{ url('/admin/stokitem/cetakalldata')}}"class="btn btn-success btn-sm"><i class="fa fa-print" aria-hidden="true"></i> Cetak Data</a>                                                                    
                                        ...
                                        <table id="table_id" class="table display">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="table-data__info">
                                                            <h6 class="">{{ $data->total_barang}} Pcs</h6>                                                          
                                                        </div>
                                                    </td>
                                               
                                                    <td>                                                                                                               
                                                           <div class="d-flex flex-row bd-highlight mb-3">
                                                               <div class="p-1 bd-highlight"><a href="{{ url('/admin/stokitem/stokid='. $data->barang_id)}}" class="btn btn-success"><i class="fa fa-eye" aria-hidden="true"></i></a></div>                                                            
