...
<body class="animsition">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="user-data m-b-30">
                                    <h3 class="title-3 m-b-30">
                                        <i class="fa fa-cube" aria-hidden="true"></i>Data Barang Masuk</h3>
                           ...
                           @endif
                                    <div class="add-data ml-4">
                                        <a href="{{ url('/admin/incomeitems/add')}}"class="btn btn-primary btn-sm"><i class="fa fa-plus-square" aria-hidden="true"></i> Tambah Barang Masuk</a>                                        
                                        <div class="btn-group">
                                            <a href="{{ url('/admin/incomeitems/cetakalldata')}}" class="btn btn-success btn-sm"><i class="fa fa-print" aria-hidden="true"></i> Cetak</a>
                                            <button type="button" class="btn btn-success dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                              <span class="sr-only">Toggle Dropdown</span>
                                            </button>
                                           <form action="{{ url('/admin/incomeitems/customCetak')}}" method="POST">
                                            @csrf
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>                                                                                                               
                                                                    <div class="d-flex flex-row bd-highlight mb-3">
                                                                        <div class="p-1 bd-highlight"><button  type="button" id="detailBarang" class="btn btn-info" data-toggle="modal" data-target="#ModalIncome"
                                                                            data-namaBarang="{{ $data->barang->nama_barang}}" data-kodeBarang="{{$data->barang->kode_barang}}"
                                                                            data-kodeSupplier="{{ $data->supplier->kode_supplier }}" data-namaSupplier="{{ $data->supplier->nama_supplier }}" 
                                                                            data-jumlahBarang="{{$data->jumlah_barang}}" data-hargaBarang="{{$data->harga_beli}}" data-oleh="{{$data->pegawai->name}}"><i class="fa fa-eye text-white" aria-hidden="true"></i></button></div>                                                                                                                                    
                                                                        <div class="p-1 bd-highlight"><a href="#" class="btn btn-danger deleteBarangMasuk" data-id="{{ $data->id}}" data-name="{{ $data->barang->nama_barang}}"><i class="fa fa-trash" aria-hidden="true"></i></a></div>
                                                                   </div>
                                                             </td> 
                                                            </tr>   
                                                        @endforeach
    ...
    <!--Detail Model -->
<div class="modal fade" id="ModalIncome" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
aria-hidden="true">
      ...
      <table class="table table-hover">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>:</td>
            <td><span id="kodeSupplier"></span></td>        
          </tr>
          <tr>
