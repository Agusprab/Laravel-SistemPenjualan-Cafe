                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="user-data m-b-30 p-3">
                                    ...
                                    <form action="{{ url('/admin/incomeitems/store')}}" method="POST">
                                        @csrf
                                            ...
                                            <div class="form-group">
                                              ...
                                              <select id="selectrole" class="form-control" name="supplier_id">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('harga_beli') is-invalid @enderror" id="inputName" name="harga_beli" required autofocus value="{{ old('nama_barang')}}">
                                                @error('harga_beli')
                                                    <div class="invalid-feedback">
                                                      {{ $message}}
                                                    </div>
                                        ...
                                        <a href="{{route('incomeitems')}}" class="btn btn-info btn-lg ">Kembali</a>
                                      </form>
                                </div>
                                <!-- END USER DATA-->
                            </div>                        
