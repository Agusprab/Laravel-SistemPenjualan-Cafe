...
<body>
    <div class="">
        ...
        <div class="text-center">
            <h3 class="mt-4">Laporan Total Barang Masuk</h3>            
            @if($custom === 1)
        ...
        <div class="mt-4">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><p>{{ $data->supplier->nama_supplier}}</p></td>
                        <td><p>{{$data->jumlah_barang}}</p></td>
                        <td><p>{{  number_format($data->harga_beli,0 ,',','.'); }}</p></td>                                       
                        <td><p>{{number_format(($data->harga_beli) * ($data->jumlah_barang))}}</p></td>  
                        {{ $total_harga = $total_harga + (($data->harga_beli) * ($data->jumlah_barang))}}
            ...
            <thead class="thead-dark">
                <tr>                    
                    ...
                    <td></td>
                    <td></td>
                    <td><p style="font-weight:bold">{{ $total_barang}} Pcs</p></td>
                    <td></td>
                    <td><p style="font-weight:bold">{{ number_format($total_harga)}}</p></td>
                </tr>
            </thead>       
                </tbody>
            </table>
